...
#define RIO_MRIF_ADDR           0x003FFFFFFFFFFF80ULL

/* riscv_iommu_msipte.notice when RIO_MSIPTE_W == 0 */
#define RIO_MRIF_NPPN_PPN       0x003FFFFFFFFFFC00ULL
#define RIO_MRIF_NPPN_N90       0x00000000000003FFULL
#define RIO_MRIF_NPPN_N10       0x10000000000003FFULL
